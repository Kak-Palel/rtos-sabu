...
from train_lightning import BiLSTMAutoencoder
...
class RealtimeAnomalyDetector:
    ...
    def __init__(self, model_path, scaler_path, feature_names, 
        ...
        self.model = BiLSTMAutoencoder.load_from_checkpoint(model_path, num_features=self.num_features)
        self.model.eval()
    ...
    def add_data_point(self, data_point):
        ...
        return error, original_denorm, reconstructed_denorm
    
    def update_history(self, timestamp, error, original, reconstructed):
